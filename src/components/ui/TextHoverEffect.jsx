  ...
  return (
    ...
    >
      ...
      <text
        ...
        strokeWidth="0.3"
        className="fill-transparent stroke-neutral-700 font-[helvetica] text-[3rem] font-bold dark:stroke-neutral-800"
      ...
      <text
        ...
        strokeWidth="0.3"
        mask="url(#textMask)"
        className="fill-transparent font-[helvetica] text-[3rem] font-bold"
      >
        {text}
      </text>
    </svg>
